...
// input can be an initial age (to be set to T+2), a parent (from whom the genome will be copied) and a mutation rate 
...
// mutate(m): flips each element with probability m
